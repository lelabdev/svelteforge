 ...
 * source so the variants cannot drift. What each bridge covers:
 *
...
export function agentInstructionFiles(template: 'base' | 'dashboard'): Record<string, string> {
	...
	return {
		...
		'.github/copilot-instructions.md':
			'<!-- Generated by SvelteForge (#347) from the same source as AGENTS.md — do not edit separately; regenerate instead. -->\n\n' +
			canonical,
