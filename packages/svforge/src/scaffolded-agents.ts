 ...
 * (#347). Recorded decision: an EXPLICITLY SUPPORTED SUBSET, not agent
 * genericity — `AGENTS.md` is the canonical file and SvelteForge documents
 * exactly which instruction files it scaffolds and for which agent. Every
 * bridge is GENERATED from that same source, so the variants are identical
 * at scaffold time. What each covers:
 *
 ...
 * AGENTS.md (#347 review). The @-import bridge (CLAUDE.md) never drifts; the Copilot/Cursor copies do. Returns the files written.
 */
